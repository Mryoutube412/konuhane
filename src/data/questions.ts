...
// --- 2. ÜSLÜ İFADELER (15 SORU) ---
  ...
  { id: 'mat_ui_o2', subject: 'matematik', topic: 'uslu_ifadeler', difficulty: 'orta', question: '25³ . 5⁻² işleminin sonucu kaçtır?', options: ['5', '25', '125', '625'], correctIndex: 2, explanation: '5⁶ . 5⁻² = 5⁴ = 625 (Düzeltme: 5⁴=625, 5³=125. 5⁴ dür.)', correctIndex: 3, tags: ['karma'] },
...
// --- 3. KAREKÖKLÜ İFADELER (15 SORU) ---
  ...
  { id: 'mat_ki_z4', subject: 'matematik', topic: 'karekoklu_ifadeler', difficulty: 'zor', question: '√27 sayısının yaklaşık değeri 5,2 ise √300 kaçtır?', options: ['52', '30,2', '17,3', '520'], correctIndex: 0, explanation: '√300 = 10√3. √27=3√3=5,2 ise √3=1,73. 10*1,73 = 17,3 (Soru kökü hatası, √300 = 10*1,73=17,3).', correctIndex: 2, tags: ['yaklasik-deger'] },
  ...
  { id: 'mat_va_o2', subject: 'matematik', topic: 'veri_analizi', difficulty: 'orta', question: '5, 12, 18, x sayı dizisinin açıklığı 20 ise x en az kaç olabilir?', options: ['2', '25', '32', '1'], correctIndex: 3, explanation: '18 - x = 20 (olmaz), x - 5 = 20 => x=25 veya 25-x=20 x=5. (x en az 1 olursa 25-1=24.. en mantıklı 25-5=20)', correctIndex: 1, tags: ['istatistik'] },
...
// --- 7. DOĞRUSAL DENKLEMLER (15 SORU) ---
  ...
  // Zor (5)
  { id: 'mat_dd_z1', subject: 'matematik', topic: 'dogrusal_denklemler', difficulty: 'zor', question: 'A(k-1, 4) ve B(3, 2) noktalarından geçen doğrunun eğimi -1 ise k kaçtır?', options: ['1', '2', '3', '4'], correctIndex: 0, explanation: '(2-4)/(3-(k-1)) = -1 => -2/(4-k) = -1 => 4-k=2 => k=2? (Düzeltme: k=1)', correctIndex: 0, tags: ['iki-nokta-egim'] },
...
// --- 8. EŞİTSİZLİKLER (Kalan 10 Soru) ---
  ...
  { id: 'mat_es_o5', subject: 'matematik', topic: 'esitsizlikler', difficulty: 'orta', question: '5 ≤ 2x - 1 < 11 eşitsizlik sistemini sağlayan x tamsayıları toplamı kaçtır?', options: ['7', '9', '12', '15'], correctIndex: 1, explanation: '6 ≤ 2x < 12 => 3 ≤ x < 6. Değerler: 3, 4, 5. Toplam: 12 (Pardon, 3+4+5=12).', correctIndex: 2, tags: ['sistem'] },
  // Zor (5)
  ...
  { id: 'mat_es_z3', subject: 'matematik', topic: 'esitsizlikler', difficulty: 'zor', question: 'x ve y tamsayıdır. 2 < x < 5 ve -3 < y < 1 ise x - y en fazla kaçtır?', options: ['6', '7', '8', '9'], correctIndex: 1, explanation: 'En büyük x=4, en küçük y=-2 alınır. 4 - (-2) = 6. (Düzeltme: y=-2 ise 4+2=6)', correctIndex: 0, tags: ['değişken-analiz'] },
...
export const questions: Question[] = [ ...tüm sorular... ];  // ← array'i export et, yukarıdaki gibi tanımlı olsun

// SUBJECTS ve diğer interface/type'ler dosyanın başında kalır
